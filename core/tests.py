...
from .admin import PremiumAPIKeyAdmin
from .models import PremiumAPIKey
from .generators import check_apikey, generate_key
...
def test_admin_save():
    ...
    apikey_admin = PremiumAPIKeyAdmin(PremiumAPIKey, admin_site=admin_site)
    assert admin_site
    assert apikey_admin
    user = User()
    user.name = get_random_string(10)
